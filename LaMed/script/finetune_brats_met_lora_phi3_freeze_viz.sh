...
output_dir=./LaMed/output/LaMed-Phi3-4B-llava-finetune-freeze-brats-met-viz-0000
accelerate launch --gpu_ids $1 --main_process_port 29600 LaMed/src/train/train.py \
    ...
    --vqa_data_test_path /local2/amvepa91/MedTrinity-25M/brats_met_3d_vqa_subjTrue_test_v1.json \
    --lora_enable True \
    --vision_tower vit3d \
