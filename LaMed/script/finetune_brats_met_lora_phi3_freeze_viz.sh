...
output_dir=./LaMed/output/LaMed-Phi3-4B-finetune-freeze-viz-met-new-dataset-0000
accelerate launch --gpu_ids $1 --main_process_port 29601 LaMed/src/train/train.py \
    --version v0 \
    --model_name_or_path microsoft/Phi-3-mini-4k-instruct \
    --model_type phi3 \
    --vqa_data_train_path /local2/amvepa91/MedTrinity-25M/brats_met_3d_vqa_subjTrue_train_updated_v2_seed0_multitask_fixed.json \
    --vqa_data_val_path /local2/amvepa91/MedTrinity-25M/brats_met_3d_vqa_subjTrue_val_updated_v2_seed0_multitask_fixed.json \
    --vqa_data_test_path /local2/amvepa91/MedTrinity-25M/brats_met_3d_vqa_subjTrue_test_updated_v2_seed0_multitask_fixed.json \
    --lora_enable True \
    --vision_tower vit3d \
