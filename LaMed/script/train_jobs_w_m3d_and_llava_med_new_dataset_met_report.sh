...
# m3d job
output_dir=./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-again-new-dataset-met_report_v11-0000
train_path=/local2/amvepa91/MedTrinity-25M/brats_met_3d_vqa_subjTrue_train_updated_v11_seed0_report.json
val_path=/local2/amvepa91/MedTrinity-25M/brats_met_3d_vqa_subjTrue_val_updated_v11_seed0_report.json
test_path=/local2/amvepa91/MedTrinity-25M/brats_met_3d_vqa_subjTrue_test_updated_v11_seed0_report.json
accelerate launch --gpu_ids $1 LaMed/src/train/train.py \
    ...
    --pretrain_mllm ./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-again-new-dataset-met_v11-0000/hf/merged_model.bin \
...
# llava-med job
output_dir=./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-llava-med-again-new-dataset-gli_met_report-v11-0000
accelerate launch --gpu_ids $1 --main_process_port 29601 LaMed/src/train/train.py \
    ...
    --freeze_vision_tower True \
    --pretrain_mm_mlp_adapter ./LaMed/pretrained_model/M3D-LaMed-Phi-3-4B/mm_projector.bin \
    --pretrain_mllm ./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-llava-med-again-new-dataset-met-v11-0000/hf/merged_model.bin \
    --vqa_data_train_path $train_path \
    --vqa_data_val_path $val_path \
    --vqa_data_test_path $test_path \
    --lora_enable True \
