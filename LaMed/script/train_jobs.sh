...
train_path=brats_gli_3d_vqa_subjTrue_train_updated_v2_seed0_multitask_fixed.json
val_path=brats_gli_3d_vqa_subjTrue_val_updated_v2_seed0_multitask_fixed.json
test_path=brats_gli_3d_vqa_subjTrue_test_updated_v2_seed0_multitask_fixed.json
...
train_path=brats_goat_3d_vqa_subjTrue_train_updated_v2_seed0_multitask_fixed.json
val_path=brats_goat_3d_vqa_subjTrue_val_updated_v2_seed0_multitask_fixed.json
test_path=brats_goat_3d_vqa_subjTrue_test_updated_v2_seed0_multitask_fixed.json
accelerate launch --gpu_ids $1 LaMed/src/train/train.py \
    --version v0 \
    --model_name_or_path microsoft/Phi-3-mini-4k-instruct \
    --model_type phi3 \
...
train_path=brats_met_3d_vqa_subjTrue_train_updated_v2_seed0_multitask_fixed.json
val_path=brats_met_3d_vqa_subjTrue_val_updated_v2_seed0_multitask_fixed.json
test_path=brats_met_3d_vqa_subjTrue_test_updated_v2_seed0_multitask_fixed.json
accelerate launch --gpu_ids $1 LaMed/src/train/train.py \
    --version v0 \
    --model_name_or_path microsoft/Phi-3-mini-4k-instruct \
    --model_type phi3 \
