...
# m3d job
output_dir=./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-again-new-dataset-gli_met_goat_v11-0000
...
test_path=/local2/amvepa91/MedTrinity-25M/brats_goat_3d_vqa_subjTrue_test_updated_v11_seed0_filt_multitask_fixed.json
...
#    --pretrain_mllm ./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-again-new-dataset-gli_met_v11-0000/hf/merged_model.bin \
...
# llava-med job
output_dir=./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-llava-med-again-new-dataset-gli_met_goat-v11-0000
...
#    --freeze_vision_tower True \
#    --pretrain_mm_mlp_adapter ./LaMed/pretrained_model/M3D-LaMed-Phi-3-4B/mm_projector.bin \
#    --pretrain_mllm ./LaMed/output/LaMed-Phi3-4B-multimodal-combined-finetune-freeze-viz-again-new-dataset-gli_met_goat_v11-0000/hf/merged_model.bin \
#    --vqa_data_train_path $train_path \
#    --vqa_data_val_path $val_path \
#    --vqa_data_test_path $test_path \
#    --lora_enable True \
