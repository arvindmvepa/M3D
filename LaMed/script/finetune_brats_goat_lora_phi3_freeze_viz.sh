...
accelerate launch --gpu_ids $1 --main_process_port 29601 LaMed/src/train/train.py \
    ...
    --model_type phi3 \
    --vqa_data_train_path /local2/amvepa91/MedTrinity-25M/brats_goat_3d_vqa_subjTrue_train_v1.json \
    --vqa_data_val_path /local2/amvepa91/MedTrinity-25M/brats_goat_3d_vqa_subjTrue_val_v1.json \
    --vqa_data_test_path /local2/amvepa91/MedTrinity-25M/brats_goat_3d_vqa_subjTrue_test_v1.json \
    --lora_enable True \
    --vision_tower vit3d \
